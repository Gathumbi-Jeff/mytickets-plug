...
export function ProductInfo({ product }: Props) {
  ...
  const isInCart = !!cartDetails ? !!cartDetails[product._id] : true;
  ...
  function addToCart() {
    ...
    toast({
      ...
      description: "Ticket added to cart",
      action: (
        <Link href="/cart">
      ...
      <form className="mt-6">
        <div className="mt-4 flex">
          <Button
            ...
            className={`w-full bg-violet-600 py-6 text-base font-medium text-white ${
              isInCart
